...
def test_create_and_save():
    ...
    oferta_cadeira1 = OfertaCadeira(horario=horario1, centro_universitario='CIn', periodo='2023.2', professor=conta_prof.id, cadeira=cadeira1.id)
    oferta_cadeira2 = OfertaCadeira(horario=horario2, centro_universitario='CIn', periodo='2023.2', professor=conta_prof.id, cadeira=cadeira2.id)
    oferta_cadeira3 = OfertaCadeira(horario=horario3, centro_universitario='CIn', periodo='2023.2', professor=conta_prof.id, cadeira=cadeira3.id)
    oferta_cadeira4 = OfertaCadeira(horario=horario4, centro_universitario='CIn', periodo='2023.2', professor=conta_prof.id, cadeira=cadeira4.id)
